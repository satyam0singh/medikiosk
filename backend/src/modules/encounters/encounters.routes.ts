...
router.post('/checkin', EncountersController.checkin);
...
router.get('/patient/:patientId/journey', EncountersController.getPatientJourney);
router.get('/patient/:patientId/medications', EncountersController.getPatientMedications);
router.get('/patient/:patientId/documents', EncountersController.getPatientDocuments);
